...
UPDATE data_officerarrest SET arrest_year_ = NULL WHERE arrest_year_='';
 ...
 UPDATE data_officerarrest SET id=id_::INTEGER, cb_number=cb_number_::INTEGER, arrest_year=arrest_year_::INTEGER, 
    appointed_date=appointed_date_::DATE, arrest_date=arrest_date_::DATE, arrest_id=arrest_id::INTEGER; 
...
\copy data_officerarrest(id, arrest_year, first_name, middle_initial, last_name, suffix_name, officer_role, star, cb_number, appointed_date, arrest_date, arrest_id) to 'relativepath/arresting-officers-solution.csv' DELIMITER ',' CSV HEADER;
